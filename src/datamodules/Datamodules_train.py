...
class Brats(LightningDataModule):
    """
    DataModule for BRATS dataset FLAIR modality
    """
    def __init__(self, cfg, fold = None):
        ...
        self.imgpath = {}
        self.csvpath_train = cfg.path.Brats_train.IDs.train[fold]
        self.csvpath_val = cfg.path.Brats_train.IDs.val[fold]
